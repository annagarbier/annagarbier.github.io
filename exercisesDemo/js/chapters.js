const teen = {
  ...
  text: {
    ...
    common: `I don't know. Maybe we all have some flaws.`,
  },
};
...
const gun_enthusiast = {
  ...
  text: {
    ...
    bridge_continue: ` says I\'m too \'stressed\' to own a gun. I don\'t use it for work though. I just use it for fun.`,
...
const worker_needing_kudos = {
  id: 'Worker Needing Kudos',
  corpus: 'r/bankers',
  steps: 6,
  text: {
...
const not_asking_for_attention = {
  id: 'Not Asking for Attention',
...
chapters = [
  ...
  worker_needing_kudos,
  restaurant_worker,
  not_asking_for_attention,
  anarchist,
  absurdist,
  mother,
  girl,
